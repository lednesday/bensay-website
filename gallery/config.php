 ...
 */
$gallery->setConfig('setup.password', 'f#rm#ntf');
 ...
 */
$gallery->setConfig('data.gallery.base', '/usr/local/www/data/bensay-gallery2/');
...
$storeConfig['database'] = 'gallery2_bensay';
$storeConfig['username'] = 'gallery2_bensay';
 ...
 */
$gallery->setConfig('galleryBaseUrl', 'http://www.cjones.org/gallery2/');
 ...
 */
$gallery->setConfig('baseUri', 'http://www.bensay.org/gallery/main.php');
?>
